...
local lualine = {
  ...
  opts = {
    sections = {
      -- Insert the AST path generated by navic into the statusline
      lualine_c = { { "navic" } },
    },
  },
}

-- navic generates a path within the AST using LSP information
local navic = {
  "SmiteshP/nvim-navic",
  opts = {
    click = true,
  ...
  config = function()
    ...
    vim.api.nvim_create_autocmd("FileType", {
      ...
      callback = function(args)
        ...
        -- Check if a parser is available for the current language.
